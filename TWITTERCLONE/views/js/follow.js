...
$(function () {
    $('.js-follow').click(function () {
        const this_obj = $(this); // クリックされた要素
        const followed_user_id = $(this).data('followed-user-id'); // followed-user-idをクリックされた要素のデータ属性から取得
        ...
        if (follow_id) {
            ...
            $.ajax({
                ...
                // 取り消し成功
                .done(() => {
                    // addClassメソッドでクラスを追加してフォローボタンを青にする
            ...
            $.ajax({
                ...
                // フォロー成功
                .done((data) => {
                    // removeClassメソッドでクラスを元に戻してフォローボタンを青にする
